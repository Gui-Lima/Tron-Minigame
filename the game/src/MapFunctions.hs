module MapFunctions where
    ...
    paint Teleportoso1 (x,y) = Pictures [translate (fst (getPoint (x,y))) (snd (getPoint (x,y))) $  color chartreuse $ rectangleSolid 10 10]
    paint Teleportoso2 (x,y) = Pictures [translate (fst (getPoint (x,y))) (snd (getPoint (x,y))) $  color chartreuse $ rectangleSolid 10 10]
    paint Teleportoso3 (x,y) = Pictures [translate (fst (getPoint (x,y))) (snd (getPoint (x,y))) $  color chartreuse $ rectangleSolid 10 10]
